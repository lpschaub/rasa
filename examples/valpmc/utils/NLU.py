...
if __name__ == '__main__':
    train = NLU(open('../data/allnlu.md', encoding='utf-8').readlines())
    train.getIntents()
    print(len(train.nlu))
    ...
    # print(len(evale.nlu))
    # evale.getIntents()
    allnlu = open("../data/newnlu.md", 'w', encoding='utf-8')
    train.writeNlu(allnlu)
    old = open('../data/newnlu.md',encoding='utf-8')
    new = open('../data/all.md','w',encoding='utf-8')
